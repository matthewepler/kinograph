public class ControlFrame extends PApplet {
  ...
  public void setup() {
    ...
    // ROI ADJUSTMENT - add click/drag functionality
    // position
  ...
  // ================================================================ UPDATE ===== //
  // Go through each GUI control and set the assoc. variable to the the current value
  public void update() {
    // Canny Edge Thresh
  ...
  void updateFile() {
    ...
    println( fileNum );
    extractor.reload( files[ fileNum ] );
  }
